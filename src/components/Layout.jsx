...
const NAV = [
  ...
  { id: "performance", label: "予実管理", icon: "M18 20V10|M12 20V4|M6 20V14" },
  { id: "financials", label: "決算書", icon: "M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z|M14 2v6h6|M16 13H8|M16 17H8" },
  { id: "cashflow", label: "資金繰り", badge: "!", icon: "M12 2v20|M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" },
  ...
  return (
    <div className="shell">
      ...
      <header className="mob-header">
        <button className="mob-hamburger" onClick={() => setMenuOpen(!menuOpen)} aria-label="メニュー">
